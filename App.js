...
const Header = ({ title, onNavigate, onLogout, lang, onLangChange }) => {
...
const SplashScreen = ({ onGetStarted, lang }) => (_jsxs("div", { className: "fixed inset-0 bg-gradient-to-br from-blue-500 to-indigo-600 flex flex-col items-center justify-center p-8 text-white text-center", children: [_jsxs("div", { className: "animate-fadeInUp", style: { animationDelay: '0.2s' }, children: [_jsx("div", { className: "mb-6 h-12 w-12 flex items-center justify-center", children: React.cloneElement(ICONS.logo, { width: 48, height: 48 }) }), _jsx("h1", { className: "text-4xl md:text-5xl font-bold mb-4", children: t('welcome_message', lang) }), _jsx("p", { className: "text-lg text-blue-200 max-w-md mx-auto", children: "The simplest way to manage your business finances." })] }), _jsx("div", { className: "fixed bottom-16", children: _jsx("button", { onClick: onGetStarted, className: "bg-white text-blue-600 font-bold py-3 px-8 rounded-full shadow-2xl text-lg hover:bg-blue-50 transition-transform transform hover:scale-105 active:scale-100 animate-fadeInUp", style: { animationDelay: '0.6s' }, children: t('get_started', lang) }) })] }));
const AuthScreen = ({ onNavigate, onGoogleLogin, onSkip, lang }) => {
    return (_jsx("div", { className: "fixed inset-0 bg-slate-50 flex flex-col justify-center items-center p-6 sm:p-8 animate-fadeIn", children: _jsxs("div", { className: "w-full max-w-sm text-center", children: [_jsx("h1", { className: "text-2xl font-semibold text-gray-600 mb-6", children: t('auth_welcome', lang) }), _jsx("div", { className: "flex justify-center mb-4", children: _jsx("div", { className: "w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center", children: React.cloneElement(ICONS.logo, { width: 40, height: 40 }) }) }), _jsx("h2", { className: "text-3xl font-bold text-gray-800 tracking-tight", children: t('app_name', lang) }), _jsx("p", { className: "text-gray-500 mt-1 mb-10", children: t('tagline', lang) }), _jsxs("div", { className: "space-y-3", children: [_jsx("button", { onClick: () => onNavigate('signup'), className: "w-full bg-blue-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg shadow-blue-500/20 hover:bg-blue-700 transition-all transform hover:-translate-y-0.5 active:scale-95 active:shadow-md", children: t('signup', lang) }), _jsx("button", { onClick: () => onNavigate('login'), className: "w-full bg-white text-gray-800 font-bold py-3 px-6 rounded-xl border-2 border-gray-200 hover:bg-gray-100 hover:border-gray-300 transition-all transform hover:-translate-y-0.5 active:scale-95", children: t('login', lang) })] }), _jsxs("div", { className: "flex items-center my-6", children: [_jsx("hr", { className: "flex-grow border-t border-gray-200" }), _jsx("span", { className: "mx-4 text-gray-400 text-sm font-medium", children: t('or_divider', lang) }), _jsx("hr", { className: "flex-grow border-t border-gray-200" })] }), _jsxs("button", { onClick: onGoogleLogin, className: "w-full bg-white text-gray-700 font-semibold py-3 px-6 rounded-xl border border-gray-200 shadow-sm hover:bg-gray-50 transition-colors flex items-center justify-center active:scale-95", children: [ICONS.google, t('login_with_google', lang)] }), _jsxs("div", { className: "mt-8", children: [_jsx("button", { onClick: onSkip, className: "text-gray-500 font-semibold text-sm hover:text-blue-600 transition-colors", children: t('skip_for_now', lang) }), _jsx("p", { className: "text-xs text-gray-400 mt-6 max-w-xs mx-auto", children: t('auth_terms_notice', lang) })] })] }) }));
};
const AuthFormCard = ({ title, children, onBack, lang }) => (_jsx("div", { className: "fixed inset-0 bg-gray-50 flex flex-col items-center justify-center p-4", children: _jsxs("div", { className: "w-full max-w-md animate-fadeInUp", children: [_jsxs("button", { onClick: onBack, className: "flex items-center text-gray-600 font-semibold mb-4 hover:text-blue-600 transition-colors group", children: [_jsx("span", { className: "p-1.5 rounded-full bg-gray-200 group-hover:bg-blue-100 transition-colors", children: React.cloneElement(ICONS.arrow_left, { className: "w-5 h-5" }) }), _jsx("span", { className: "ml-2", children: t('back', lang) })] }), _jsxs("div", { className: "bg-white p-8 sm:p-10 rounded-2xl shadow-2xl border border-gray-200", children: [_jsx("h1", { className: "text-3xl font-bold text-gray-800 mb-8 text-center", children: title }), children] })] }) }));
const SignUpScreen = ({ onSignUp, onNavigate, lang }) => {
    ...
    return (_jsx(AuthFormCard, { title: t('create_your_account', lang), onBack: () => onNavigate('auth'), lang: lang, children: _jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [_jsx("input", { type: "email", placeholder: t('email', lang), required: true, className: inputStyle }), _jsx("input", { type: "password", placeholder: t('password', lang), required: true, className: inputStyle }), _jsxs("select", { required: true, value: businessType, onChange: e => setBusinessType(e.target.value), className: selectStyle, children: [_jsx("option", { value: "", disabled: true, children: t('business_type', lang) }), _jsx("option", { value: BusinessType.Kirana, children: t('business_kirana', lang) }), _jsx("option", { value: BusinessType.Pharmacy, children: t('business_pharmacy', lang) }), _jsx("option", { value: BusinessType.Electronics, children: t('business_electronics', lang) }), _jsx("option", { value: BusinessType.HotelRestaurant, children: t('business_hotel_restaurant', lang) }), _jsx("option", { value: BusinessType.Other, children: t('business_other', lang) })] }), _jsx("button", { type: "submit", className: "w-full bg-blue-500 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:bg-blue-600 transition-colors", children: t('signup', lang) }), _jsxs("p", { className: "text-center text-sm text-gray-500 pt-2", children: [t('already_have_account', lang), " ", _jsx("button", { type: "button", onClick: () => onNavigate('login'), className: "font-semibold text-blue-600 hover:underline", children: t('login', lang) })] })] }) }));
};
const LoginScreen = ({ onLogin, onNavigate, lang }) => {
    const inputStyle = "block w-full rounded-lg border-0 py-2.5 px-3.5 bg-gray-100 text-gray-900 ring-1 ring-inset ring-gray-200 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6 transition-colors duration-200";
    return (_jsx(AuthFormCard, { title: t('welcome_back', lang), onBack: () => onNavigate('auth'), lang: lang, children: _jsxs("form", { onSubmit: (e) => { e.preventDefault(); onLogin(); }, className: "space-y-5", children: [_jsx("input", { type: "email", placeholder: t('email', lang), required: true, className: inputStyle }), _jsx("input", { type: "password", placeholder: t('password', lang), required: true, className: inputStyle }), _jsx("button", { type: "submit", className: "w-full bg-blue-500 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:bg-blue-600 transition-colors", children: t('login', lang) }), _jsxs("p", { className: "text-center text-sm text-gray-500 pt-2", children: [t('dont_have_account', lang), " ", _jsx("button", { type: "button", onClick: () => onNavigate('signup'), className: "font-semibold text-blue-600 hover:underline", children: t('signup', lang) })] })] }) }));
};
// #endregion
const MainApp = ({ lang, onLangChange, onLogout, businessType }) => {
    ...
    return (_jsxs("div", { className: "max-w-4xl mx-auto bg-slate-50 min-h-screen pb-28", children: [_jsx(Header, { title: pageTitles[activeView], onNavigate: setActiveView, onLogout: onLogout, lang: lang, onLangChange: onLangChange }), _jsx("main", { children: renderActiveView() }), isMainView && _jsx(BottomNav, { activeView: activeView, onViewChange: setActiveView, lang: lang }), _jsx(AddTransactionModal, { isOpen: isAddTxModalOpen, onClose: () => setAddTxModalOpen(false), onSave: data.addTransaction, contacts: data.contacts, onAddContact: (name) => data.addContact({ name }), initialType: initialTxType, lang: lang, businessType: businessType || BusinessType.Other }), _jsx(SettleModal, { isOpen: isSettleModalOpen, onClose: () => setSettleModalOpen(false), onSave: data.addSettlement, balanceData: settleTarget, lang: lang })] }));
};
function App() {
    const [lang, setLang] = useLocalStorage('hisab_language', 'en');
    const [businessType, setBusinessType] = useLocalStorage('hisab_business_type', null);
    ...
    const renderContent = () => {
        if (view === 'splash' && !isReady) {
            return _jsx(SplashScreen, { onGetStarted: () => setView('auth'), lang: lang });
        }
        if (!isAuthenticated) {
            switch (view) {
                case 'auth':
                    return _jsx(AuthScreen, { onNavigate: setView, onGoogleLogin: () => handleAuthSuccess(), onSkip: () => handleAuthSuccess(), lang: lang });
                case 'login':
                    return _jsx(LoginScreen, { onLogin: () => handleAuthSuccess(), onNavigate: setView, lang: lang });
                case 'signup':
                    return _jsx(SignUpScreen, { onSignUp: handleAuthSuccess, onNavigate: setView, lang: lang });
                default:
                    return _jsx(AuthScreen, { onNavigate: setView, onGoogleLogin: () => handleAuthSuccess(), onSkip: () => handleAuthSuccess(), lang: lang });
            }
        }
        return _jsx(MainApp, { lang: lang, onLangChange: setLang, onLogout: handleLogout, businessType: businessType });
    };
